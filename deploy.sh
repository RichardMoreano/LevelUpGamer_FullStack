...
echo "• GitHub Pages Settings: https://github.com/RichardMoreano/LevelUpGamer_FullStack/settings/pages"
echo "• GitHub Repository: https://github.com/RichardMoreano/LevelUpGamer_FullStack"
